...
(function () {
    ...
    function injectDesktopNavigation() {
        ...
        const navHTML = `
            <a class="nav-item px-6 py-2.5 rounded-full text-sm font-medium uppercase tracking-wide transition-colors duration-200 ${pathname === '/' || pathname === '/index.html' || pathname === '' ? 'text-primary' : 'text-white hover:text-primary'}"
                href="/">Trang chủ</a>
            ...
            <div class="relative group">
                ...
                <div
                    ...
                    <a href="/phim-theo-quoc-gia?country=viet-nam"
            ...
            <div class="relative group">
                <button
                    class="nav-item px-6 py-2.5 rounded-full text-sm font-medium uppercase tracking-wide transition-colors duration-200 ${pathname.includes('danh-sach') ? 'text-primary' : 'text-white hover:text-primary'} flex items-center gap-1">
                    Danh Sách
                    <span
                        class="material-icons-round text-sm group-hover:rotate-180 transition-transform duration-300">expand_more</span>
                </button>
                <div
                    ...
                    <div class="grid grid-cols-3 gap-0">
                        ...
                        <a href="/danh-sach?list=hoat-hinh"
                            ...
                            Hình</a>
                        <a href="/danh-sach?list=phim-vietsub"
                            class="block px-5 py-4 text-gray-300 hover:text-primary hover:bg-white/5 transition-all border-b border-white/5">Phim
                            Vietsub</a>
                        <a href="/danh-sach?list=phim-thuyet-minh"
                            class="block px-5 py-4 text-gray-300 hover:text-primary hover:bg-white/5 transition-all border-r border-b border-white/5">Phim
                            Thuyết Minh</a>
                        <a href="/danh-sach?list=phim-long-tien"
                            class="block px-5 py-4 text-gray-300 hover:text-primary hover:bg-white/5 transition-all border-r border-b border-white/5">Phim
                            Lồng Tiếng</a>
                        <a href="/danh-sach?list=phim-bo-dang-chieu"
                            class="block px-5 py-4 text-gray-300 hover:text-primary hover:bg-white/5 transition-all border-b border-white/5">Phim
                            Bộ Đang Chiếu</a>
                        <a href="/danh-sach?list=phim-bo-hoan-thanh"
                            class="block px-5 py-4 text-gray-300 hover:text-primary hover:bg-white/5 transition-all border-r border-white/5">Phim
                            Bộ Đã Hoàn Thành</a>
                        <a href="/danh-sach?list=phim-sap-chieu"
                            class="block px-5 py-4 text-gray-300 hover:text-primary hover:bg-white/5 transition-all border-r border-white/5">Phim
                            Sắp Chiếu</a>
                        <a href="/danh-sach?list=subteam"
                            class="block px-5 py-4 text-gray-300 hover:text-primary hover:bg-white/5 transition-all">Subteam</a>
                        <a href="/danh-sach?list=phim-chieu-rap"
            ...
            <a class="nav-item px-6 py-2.5 rounded-full text-sm font-medium uppercase tracking-wide transition-colors duration-200 ${pathname.includes('categories') ? 'text-primary' : 'text-white hover:text-primary'}"
                href="/categories">Thể Loại</a>
            <a class="nav-item px-6 py-2.5 rounded-full text-sm font-medium uppercase tracking-wide transition-colors duration-200 ${pathname.includes('search') ? 'text-primary' : 'text-white hover:text-primary'}"
                href="/search">Khám phá</a>
            <a class="nav-item px-6 py-2.5 rounded-full text-sm font-medium uppercase tracking-wide transition-colors duration-200 ${pathname.includes('pricing') ? 'text-primary' : 'text-white hover:text-primary'}"
