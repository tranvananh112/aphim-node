...
function renderResults(movies) {
    ...
    resultsGrid.innerHTML = movies.map(movie => {
        ...
        const posterUrl = (typeof imageOptimizer !== 'undefined' && rawImg)
            ...
            : (rawImg.startsWith('http') ? rawImg : (rawImg ? (rawImg.startsWith('uploads/') ? `https://phimimg.com/${rawImg}` : `https://phimimg.com/${rawImg}`) : 'https://via.placeholder.com/400x600?text=No+Image'));
