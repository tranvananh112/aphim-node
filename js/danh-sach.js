...
function renderMoviesTable(movies, listName, totalItems, totalPages_api) {
    ...
    movies.forEach((movie) => {
        ...
        const posterUrl = (typeof imageOptimizer !== 'undefined' && rawImg)
            ...
            : (rawImg.startsWith('http') ? rawImg : (rawImg ? (rawImg.startsWith('uploads/') ? `https://phimimg.com/${rawImg}` : `https://phimimg.com/${rawImg}`) : 'https://via.placeholder.com/200x300?text=No+Image'));
